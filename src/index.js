...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (savedList && savedList.length > 0) {
    ...
    let newTodo = todo.createTodo(
      ...
      "Click the button atop this page",
      "red",
      startOfDay(new Date()),
      "None",
    );
    let newTodo2 = todo.createTodo(
      "Create a project",
      "Projects are like folders for your todos, button is atop this page",
      "yellow",
      startOfDay(new Date()),
      "None",
    );
    let newTodo3 = todo.createTodo(
      "Complete a todo",
      "Once you have completed a task, check the circle to the left to mark it as completed!",
      "blue",
      startOfDay(new Date()),
      "None",
    );
